    ...
    for unit in unitlist:
        ...
        for item in twos:  # Loop through list of twos
            ...
            for match_check in twos:  # Loop through remaining boxes in twos list
                if values[item] == values[match_check]:  # Check to see if item values match with match_check
                    ...
                    for box in [box for box in unit if box not in [item, match_check]]:  # Loop through the unit
                        value = "".join([v for v in values[box] if v not in single_twin])  # Remove twin values
                        values = assign_value(values, box, value)  # Assign the filterd value to values[box]
